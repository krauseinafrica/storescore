...
LESSONS = [
    ...
    {
        'order': 7,
        'title': 'Install an Evaluation Template',
        'summary': 'Browse the template library and install a pre-built evaluation template. You can customize it later to match your needs.',
        'section_anchor': 'templates-overview',
        'app_route': '/templates#library',
        'action_label': 'Browse template library',
        'roles': 'owner,admin',
        'feature_tier': 'starter',
    },
    {
    ...
    },
    {
        ...
        'summary': 'Photo-based self-checks with AI analysis, submitted by store managers between walks. Reviewers can override AI ratings and add commentary.',
