    ...
    <div className="px-4 sm:px-6 lg:px-8 py-6 pb-24">
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          ...
          className="inline-flex items-center justify-center gap-2 w-9 h-9 sm:w-auto sm:h-auto sm:px-4 sm:py-2 text-sm font-semibold text-white bg-primary-600 rounded-full sm:rounded-lg hover:bg-primary-700 transition-colors flex-shrink-0"
        >
